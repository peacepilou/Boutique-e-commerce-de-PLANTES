...
personList.forEach((person) => {
    console.log(`
        La personne ${person.firstname} 
        a ${person.age} 
        et elle est ${person.isLegal === true ? "est majeur(e)" : "n'est pas majeure"}
    `);
});

// name == "Bob" ? console.log("slt bob") : console.log("mais qui es-tu donc jeune éphèbe")
// const name = "Bob";

// if (name === "Bob") {
//     console.log("slt bob");
// } else {
//     console.log("mais qui es-tu donc jeune éphèbe");
// }
